...
This interaction begins when the user uses the 'condoc AI-sandboxing/discussion/condocs-examples/verbose/Simple.md "A simple conversational document where we create great content about cats."' into the federation-command CLI.
...
The condoc handler finds that the 'AI-sandboxing/discussion/condocs-examples/verbose/' directory has the repository root 'AI-sandboxing'.
...
The handler creates the 'step-file' child document for the first step - 'AI-sandboxing/discussion/condocs-examples/verbose/simpleImpls/Step1Prompt.md' and copies the prompt into it as a starting point under the '# Prompt' header.
